...
if (document.images) { // tests for image support
  ...
  trilinos_title_normal.src = "<?php echo $dir ?>../img/trilinos_title_normal.png";
  trilinos_title_over = new Image(310, 55);
  trilinos_title_over.src = "<?php echo $dir ?>../img/trilinos_title_over.png";

  sandia_normal = new Image(180, 29);
  sandia_normal.src = "<?php echo $dir ?>../img/sandia_normal.png";
  sandia_over = new Image(180, 29);
  sandia_over.src = "<?php echo $dir ?>../img/sandia_over.png";
  
  trilinos_normal = new Image(183, 100);
  trilinos_normal.src = "<?php echo $dir ?>../img/trilinos_normal.png";
  trilinos_over = new Image(183, 100);
  trilinos_over.src = "<?php echo $dir ?>../img/trilinos_over.png";
