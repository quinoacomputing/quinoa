...
#
#    $MOOCHO_BASE_DIR/moocho/src/NLPInterfacePack/refactoring
#
# is where this file is.  Trilinos/commonTools/refactoring must also
# be added to your path.
#

token-replace-list-r $MOOCHO_BASE_DIR/moocho/src/NLPInterfacePack/refactoring/new-header-includes.20051209.txt
