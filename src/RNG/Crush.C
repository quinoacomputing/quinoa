...
//******************************************************************************
{
  ...
  add< TestU01< sres_Basic, sres_CreateBasic, sres_DeleteBasic,
     ...
     ( id, gen, rng, StatTest::Names( {"Serial Over t=2"} ),
       SerialOver, 1L, 500L * MILLION, 0, 4096L, 2 );

  // Marsaglia's Serial Over, t = 4
  add< TestU01< sres_Basic, sres_CreateBasic, sres_DeleteBasic,
                long, long, int, long, int > >
     ( id, gen, rng, StatTest::Names( {"Serial Over t=4"} ),
  ...
  add< TestU01< snpair_Res, snpair_CreateRes, snpair_DeleteRes,
     ...
     ( id, gen, rng, StatTest::Names( {"Close Pairs NP t=2",
                                       "Close Pairs mNP t=2",
  ...
  add< TestU01< snpair_Res, snpair_CreateRes, snpair_DeleteRes,
                long, long, int, int > >
     ( id, gen, rng, StatTest::Names( {"Close Pairs Bit Match t=2"} ),
       ClosePairsBitMatch, 4L, 4L * MILLION, 0, 2 );

  // Close Pairs Bit Match, t = 4
  add< TestU01< snpair_Res, snpair_CreateRes, snpair_DeleteRes,
                long, long, int, int > >
     ( id, gen, rng, StatTest::Names( {"Close Pairs Bit Match t=4"} ),
  ...
  add< TestU01< sres_Chi2, sres_CreateChi2, sres_DeleteChi2,
                long, long, int, double, double > >
       ( id, gen, rng, StatTest::Names( {"Gap r=27"} ),
         Gap, 1L, 100L * MILLION, 27, 0.0, 0.125 );

  // Knuth's Gap, r = 0, n = 5e+6
  add< TestU01< sres_Chi2, sres_CreateChi2, sres_DeleteChi2,
                long, long, int, double, double > >
       ( id, gen, rng, StatTest::Names( {"Gap r=0 n=5M"} ),
         Gap, 1L, 5L * MILLION, 0, 0.0, 1.0/256.0 );

  // Knuth's Gap, r = 22, n = 5e+6
  add< TestU01< sres_Chi2, sres_CreateChi2, sres_DeleteChi2,
                long, long, int, double, double > >
       ( id, gen, rng, StatTest::Names( {"Gap r=22 n=5M"} ),
  ...
  add< TestU01< sres_Chi2, sres_CreateChi2, sres_DeleteChi2,
                long, long, int, int > >
       ( id, gen, rng, StatTest::Names( {"Permutation r=0"} ),
         Permutation, 1L, 50L * MILLION, 0, 10 );

  // Knuth's Permutation, r = 15
  add< TestU01< sres_Chi2, sres_CreateChi2, sres_DeleteChi2,
                long, long, int, int > >
       ( id, gen, rng, StatTest::Names( {"Permutation r=15"} ),
  ...
  add< TestU01< sknuth_Res2, sknuth_CreateRes2, sknuth_DeleteRes2,
                long, long, int, int > >
       ( id, gen, rng, StatTest::Names( {"Collision w. Permutations r=15"} ),
  ...
  add< TestU01< sknuth_Res1, sknuth_CreateRes1, sknuth_DeleteRes1,
       ...
       ( id, gen, rng, StatTest::Names( {"Maximum-of-t t=5",
  ...
  add< TestU01< sknuth_Res1, sknuth_CreateRes1, sknuth_DeleteRes1,
                long, long, int, int, int, gofw_TestType, gofw_TestType > >
       ( id, gen, rng, StatTest::Names( {"Maximum-of-t t=10",
  ...
  add< TestU01< sknuth_Res1, sknuth_CreateRes1, sknuth_DeleteRes1,
                long, long, int, int, int, gofw_TestType, gofw_TestType > >
       ( id, gen, rng, StatTest::Names( {"Maximum-of-t t=20",
  ...
  add< TestU01< sknuth_Res1, sknuth_CreateRes1, sknuth_DeleteRes1,
                long, long, int, int, int, gofw_TestType, gofw_TestType > >
       ( id, gen, rng, StatTest::Names( {"Maximum-of-t t=30",
  ...
  add< TestU01< sres_Basic, sres_CreateBasic, sres_DeleteBasic,
                long, long, int, int > >
       ( id, gen, rng, StatTest::Names( {"Sample Products t=10"} ),
         SampleProd, 1L, 10L * MILLION, 0, 10 );

  // Sample Products, t = 30
  add< TestU01< sres_Basic, sres_CreateBasic, sres_DeleteBasic,
                long, long, int, int > >
       ( id, gen, rng, StatTest::Names( {"Sample Products t=30"} ),
         SampleProd, 1L, 10L * MILLION, 0, 30 );

  // Sample Mean
  add< TestU01< sres_Basic, sres_CreateBasic, sres_DeleteBasic,
                long, long, int > >
       ( id, gen, rng, StatTest::Names( {"Sample Mean"} ),
         SampleMean, 10L * MILLION, 20L, 0 );

  // Sample Autorrelation
  add< TestU01< sres_Basic, sres_CreateBasic, sres_DeleteBasic,
                long, long, int, int > >
       ( id, gen, rng, StatTest::Names( {"Sample Autorrelation"} ),
  ...
  add< TestU01< sres_Basic, sres_CreateBasic, sres_DeleteBasic,
                long, long, long, int, int, int > >
       ( id, gen, rng, StatTest::Names( {"Appearance Spacings r=20"} ),
  ...
  add< TestU01< sres_Chi2, sres_CreateChi2, sres_DeleteChi2,
                long, long, int, long, double, double > >
       ( id, gen, rng, StatTest::Names( {"Weight Distribution r=8"} ),
         WeightDistrib, 1L, 2L * MILLION, 8, 256L, 0.0, 0.125 );

  // Weight Distribution, r = 16
  add< TestU01< sres_Chi2, sres_CreateChi2, sres_DeleteChi2,
                long, long, int, long, double, double > >
       ( id, gen, rng, StatTest::Names( {"Weight Distribution r=16"} ),
         WeightDistrib, 1L, 2L * MILLION, 16, 256L, 0.0, 0.125 );

  // Weight Distribution, r = 24
  add< TestU01< sres_Chi2, sres_CreateChi2, sres_DeleteChi2,
                long, long, int, long, double, double > >
       ( id, gen, rng, StatTest::Names( {"Weight Distribution r=24"} ),
  ...
  add< TestU01< smarsa_Res2, smarsa_CreateRes2, smarsa_DeleteRes2,
              long, long, int, int > >
     ( id, gen, rng, StatTest::Names( {"GCD r=0"} ),
       GCD, 1L, 100L * MILLION, 0, 30 );

  // Marsaglia's greatest common divisor, r = 10
  add< TestU01< smarsa_Res2, smarsa_CreateRes2, smarsa_DeleteRes2,
              long, long, int, int > >
     ( id, gen, rng, StatTest::Names( {"GCD r=10"} ),
  ...
  add< TestU01< swalk_Res, swalk_CreateRes, swalk_DeleteRes,
       ...
       ( id, gen, rng, StatTest::Names( {"Random Walk 1 Stat H L=90 r=0",
  ...
  add< TestU01< swalk_Res, swalk_CreateRes, swalk_DeleteRes,
                long, long, int, int, long, long > >
       ( id, gen, rng, StatTest::Names( {"Random Walk 1 Stat H L=90 r=20",
  ...
  add< TestU01< swalk_Res, swalk_CreateRes, swalk_DeleteRes,
                long, long, int, int, long, long > >
       ( id, gen, rng, StatTest::Names( {"Random Walk 1 Stat H L=10000 r=20",
  ...
  add< TestU01< sres_Basic, sres_CreateBasic, sres_DeleteBasic,
                long, int, int, int > >
       ( id, gen, rng, StatTest::Names( {"Lempel-Ziv Compressibility"} ),
  ...
  add< TestU01< sspectral_Res, sspectral_CreateRes, sspectral_DeleteRes,
                long, int, int, int > >
       ( id, gen, rng, StatTest::Names( {"Fourier 3 r=20"} ),
  ...
  add< TestU01< sstring_Res2, sstring_CreateRes2, sstring_DeleteRes2,
                long, long, int, int, long > >
       ( id, gen, rng, StatTest::Names( {"Longest Head Run Chi r=20",
  ...
  add< TestU01< sres_Chi2, sres_CreateChi2, sres_DeleteChi2,
                long, long, int, int > >
       ( id, gen, rng, StatTest::Names( {"Periods In Strings r=15"} ),
  ...
  add< TestU01< sres_Basic, sres_CreateBasic, sres_DeleteBasic,
                long, long, int, int, long > >
       ( id, gen, rng, StatTest::Names( {"Hamming Weight 2 r=20"} ),
  ...
  add< TestU01< sstring_Res, sstring_CreateRes, sstring_DeleteRes,
                long, long, int, int, int, int > >
       ( id, gen, rng, StatTest::Names( {"Hamming Independence L=30 r=20"} ),
  ...
  add< TestU01< sstring_Res, sstring_CreateRes, sstring_DeleteRes,
                long, long, int, int, int, int > >
       ( id, gen, rng, StatTest::Names( {"Hamming Independence L=300 r=20"} ),
  ...
  add< TestU01< sstring_Res, sstring_CreateRes, sstring_DeleteRes,
                long, long, int, int, int, int > >
       ( id, gen, rng, StatTest::Names( {"Hamming Independence L=1200 r=20"} ),
  ...
  add< TestU01< sstring_Res3, sstring_CreateRes3, sstring_DeleteRes3,
                long, long, int, int > >
       ( id, gen, rng, StatTest::Names( {"String Run NRuns r=20",
  ...
  add< TestU01< sres_Basic, sres_CreateBasic, sres_DeleteBasic,
                long, long, int, int, int > >
       ( id, gen, rng, StatTest::Names( {"Autocorrelation d=1 r=20"} ),
         AutoCor, 5L, 1L + BILLION, 20, 10, 1 );

  // Autocorrelation, d = 30, r = 0
  add< TestU01< sres_Basic, sres_CreateBasic, sres_DeleteBasic,
                long, long, int, int, int > >
       ( id, gen, rng, StatTest::Names( {"Autocorrelation d=30 r=0"} ),
         AutoCor, 10L, 31L + BILLION, 0, 30, 30 );

  // Autocorrelation, d = 10, r = 20
  add< TestU01< sres_Basic, sres_CreateBasic, sres_DeleteBasic,
                long, long, int, int, int > >
       ( id, gen, rng, StatTest::Names( {"Autocorrelation d=10 r=20"} ),
