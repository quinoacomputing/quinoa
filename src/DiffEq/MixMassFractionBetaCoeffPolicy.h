  ...
  public:
      ...
      tk::real t ) const
    {
      ...
      for (ncomp_t c=0; c<ncomp; ++c) {
        ...
        //tk::real f = 1.0 / std::pow( 1.0 + std::pow(pe-1.0,2.0), 0.5 );//*std::pow(ds,0.5) );
