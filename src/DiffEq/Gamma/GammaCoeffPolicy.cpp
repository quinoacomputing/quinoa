// *****************************************************************************
/*!
  \file      src/DiffEq/Gamma/GammaCoeffPolicy.cpp
  \copyright 2012-2015 J. Bakosi,
             2016-2018 Los Alamos National Security, LLC.,
             2019 Triad National Security, LLC.
             All rights reserved. See the LICENSE file for details.
  \brief     Gamma coefficients policies
  \details   This file defines coefficients policy classes for the gamma
             SDE, defined in DiffEq/Gamma/Gamma.h. For general requirements on
             Gamma SDE coefficients policy classes see the header file.
*/
// *****************************************************************************

#include "GammaCoeffPolicy.hpp"

walker::GammaCoeffConst::GammaCoeffConst(
