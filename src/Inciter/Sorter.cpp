...
// *****************************************************************************
{
  ...
  if (g_inputdeck.get< newtag::cmd, tag::feedback >()) m_host.chcomm();

  tk::destroy( m_nodech );
  tk::destroy( m_chnode );

  if (g_inputdeck.get< newtag::pelocal_reorder >())
...
// *****************************************************************************
{
  ...
  if ( g_inputdeck.get< newtag::cmd, tag::feedback >() ) m_host.chmask();
...
// *****************************************************************************
{
  ...
  if ( g_inputdeck.get< newtag::cmd, tag::feedback >() ) m_host.chreordered();
...
// *****************************************************************************
{
  ...
  if ( g_inputdeck.get< newtag::cmd, tag::feedback >() ) m_host.chcreated();
