...
//! \param[in] v1 (x,y,z) coordinates of 1st local node in the tetrahedron
//! \param[in] v2 (x,y,z) coordinates of 2nd local node in the tetrahedron
//! \param[in] v3 (x,y,z) coordinates of 3rd local node in the tetrahedron
//! \param[in] v4 (x,y,z) coordinates of 4th local node in the tetrahedron
