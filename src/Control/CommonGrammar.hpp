...
namespace grm {
  ...
  static const std::map< MsgKey, std::string > message{
    ...
    { MsgKey::BGICMISSING, "Background initial conditions not specified. If a "
      "particular test problem is NOT configured, the default problem type is "
      "user-defined. A user-defined problem requires an ic ... end block in "
      "the input file, specifying at least the background ICs for physics "
      "variables." },
