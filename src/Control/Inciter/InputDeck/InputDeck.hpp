...
class InputDeck : public tk::TaggedTuple< ConfigMembers > {
  ...
  public:
    ...
    explicit InputDeck( const CmdLine& cl = {} ) {
      ...
      */
      // -----------------------------------------------------------------------
      std::vector< tk::entry_t > keywords;

      keywords.push_back({"inciter",
      ...
      keywords.push_back({"title", "Title", R"(The title may be specified in
      ...
      keywords.push_back({"nstep", "Set number of time steps to take",
      ...
      keywords.push_back({"term", "Set maximum physical time to simulate",
      ...
      keywords.push_back({"t0", "Set starting non-dimensional time",
        R"(This keyword is used to specify the starting time in a simulation.)",
        "real"});

      keywords.push_back({"dt", "Select constant time step size",
      ...
      keywords.push_back({"ttyi", "Set screen output interval",
      ...
      keywords.push_back({"partitioning",
      ...
      keywords.push_back({"pelocal_reorder",
        "PE-local reorder",
      ...
      keywords.push_back({"operator_reorder",
      ...
      keywords.push_back({"scheme", "Select discretization scheme",
      ...
      keywords.push_back({"ndof", "Number of evolved solution DOFs",
        R"(The number of solution DOFs that are evolved.)", "uint"});

      keywords.push_back({"rdof", "Total number of solution DOFs",
      ...
      keywords.push_back({"limiter", "Select limiter function",
      ...
      keywords.push_back({"nolimiter", "No limiter used",
      ...
      keywords.push_back({"shock_detector_coeff",
      ...
      keywords.push_back({"vertexbasedp1",
      ...
      keywords.push_back({"accuracy_test", "Toggle accuracy test setup",
      ...
      keywords.push_back({"limsol_projection",
      ...
      keywords.push_back({"prelax_timescale",
      ...
      keywords.push_back({"intsharp_param",
      ...
      keywords.push_back({"navierstokes",
      ...
      keywords.push_back({"energy_pill",
      ...
      keywords.push_back({"de_jwl", "JWL EoS de parameter",
      ...
      keywords.push_back({"rhor_jwl", "JWL EoS rhor parameter",
      ...
      keywords.push_back({"Tr_jwl", "JWL EoS Tr parameter",
      ...
      keywords.push_back({"Pr_jwl", "JWL EoS er parameter",
      ...
      keywords.push_back({"mu", "shear modulus/dynamic viscosity",
      ...
      keywords.push_back({"field_output",
      ...
      keywords.push_back({"time_interval",
      ...
      keywords.push_back({"refined", "Toggle refined field output on/off",
      ...
      keywords.push_back({"diagnostics",
      ...
      keywords.push_back({"error", "Select an error type",
      ...
      keywords.push_back({"history_output",
      ...
      keywords.push_back({"coord", "Specify point coordinates",
        R"(This keyword is used to specify coordinates of the history-point.)",
        "3 reals"});

      keywords.push_back({"exodusii", "Select ExodusII output",
        R"(This keyword is used to select the
      ...
      keywords.push_back({"density", "Request/specify density",
      ...
      keywords.push_back({"mesh_velocity", "Select mesh velocity",
      ...
      keywords.push_back({"mesh_motion",
      ...
      keywords.push_back({"meshforce", "Set ALE mesh force model parameter(s)",
      ...
      keywords.push_back({"t0ref", "Enable mesh refinement at t<0",
      ...
      keywords.push_back({"dtref", "Enable mesh refinement at t>0",
        R"(This keyword is used to enable solution-adaptive mesh refinement during
        time stepping.)", "bool"});

      keywords.push_back({"dtref_uniform",
      ...
      keywords.push_back({"tol_refine", "Configure refine tolerance",
      ...
      keywords.push_back({"spectral_decay",
      ...
      keywords.push_back({"non_conformity",
      ...
      keywords.push_back({"radius", "Specify a radius",
      ...
      keywords.push_back({"velocity", "Specify velocity",
      ...
      keywords.push_back({"materialid", "Specify material id",
      ...
      keywords.push_back({"blockid", "Specify mesh block id",
      ...
      keywords.push_back({"init_time","Specify the initialization time",
      ...
      keywords.push_back({"front_width", "Specify a front width",
      ...
      keywords.push_back({"front_speed", "Specify a front speed",
      ...
      keywords.push_back({"filename", "Set filename",
        R"(Set filename, e.g., mesh filename for solver coupling.)", "string"});

      keywords.push_back({"location", "Configure location",
      ...
      keywords.push_back({"user_defined",
      ...
      keywords.push_back({"vortical_flow",
      ...
      keywords.push_back({"nl_energy_growth",
      ...
      keywords.push_back({"rayleigh_taylor",
      ...
      keywords.push_back({"taylor_green",
      ...
      keywords.push_back({"sod_shocktube",
      ...
      keywords.push_back({"rotated_sod_shocktube",
      ...
      keywords.push_back({"shedding_flow",
      ...
      keywords.push_back({"sedov_blastwave",
      ...
      keywords.push_back({"interface_advection",
      ...
      keywords.push_back({"gauss_hump_compflow",
        "Select advection of 2D Gaussian hump test problem",
        R"(This keyword is used to select the advection of 2D Gaussian hump test
        problem. The initial and boundary conditions are specified to set up the
      ...
      keywords.push_back({"waterair_shocktube",
      ...
      keywords.push_back({"shock_hebubble",
      ...
      keywords.push_back({"underwater_ex",
      ...
      keywords.push_back({"shockdensity_wave",
      ...
      keywords.push_back({"equilinterface_advect",
