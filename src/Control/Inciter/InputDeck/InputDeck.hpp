    ...
    explicit InputDeck( const CmdLine& cl = {} ) {
      ...
      */
      ...
      keywords.insert({"hardening_c2", "Strain-hardening coefficient c2",
        ...
        in the strain-hardening law sigma_Y = c1 + c2*eps_p^n, where c1 is
        the yield_stress. Units: Pa. Default: 0.0 (no hardening).)",
        "vector of reals"});
      ...
      keywords.insert({"hardening_n", "Strain-hardening exponent n",
        ...
        the strain-hardening law sigma_Y = c1 + c2*eps_p^n. Default: 1.0.)",
        "vector of reals"});
