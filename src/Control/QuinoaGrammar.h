...
/*!
  ...
  \author    J. Bakosi
  \date      Mon 02 Sep 2013 08:16:18 AM MDT
...
//   struct cstore : action_base< cstore<tag> > {
//     static void apply(const std::string& value, Stack& stack) {
//       // Convert to correct type and store element 'at' position
//       std::get<at>(stack) =
...
//     static void apply(const std::string& value, Stack& stack) {
//       // Convert to correct type and push element to vector 'at' position
