// *****************************************************************************
/*!
  \file      src/PDE/MultiMat/Problem/GasImpact4Mat.cpp
...
// *****************************************************************************
{
  ...
  Assert( ncomp == 15, "Number of scalar components must be 15" );
  ...
  s[volfracIdx(nmat, 3)] = 1.0-2.0*alphamin;
...
MultiMatProblemGasImpact4Mat::names( ncomp_t )
// *****************************************************************************
