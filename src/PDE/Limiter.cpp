...
// *****************************************************************************
{
  ...
  const auto cweight = inciter::g_inputdeck.get< newtag::cweight >();
...
// *****************************************************************************
{
  const auto rdof = inciter::g_inputdeck.get< newtag::rdof >();
  const auto ndof = inciter::g_inputdeck.get< newtag::ndof >();
  const auto intsharp = inciter::g_inputdeck.get< newtag::multimat,
    newtag::intsharp >();
  std::size_t ncomp = U.nprop()/rdof;
...
// *****************************************************************************
{
  const auto rdof = inciter::g_inputdeck.get< newtag::rdof >();
  const auto ndof = inciter::g_inputdeck.get< newtag::ndof >();
  const auto intsharp = inciter::g_inputdeck.get< newtag::transport,
    newtag::intsharp >();
  std::size_t ncomp = U.nprop()/rdof;
...
// *****************************************************************************
{
  ...
  if (inciter::g_inputdeck.get< newtag::shock_detector_coeff >()
    > 1e-6)
...
// *****************************************************************************
{
  const auto coeff = g_inputdeck.get< newtag::shock_detector_coeff >();
