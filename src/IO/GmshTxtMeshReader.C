...
/*!
  ...
  \author    J. Bakosi
  \date      Wed 01 May 2013 09:41:20 PM MDT
...
//******************************************************************************
{
  ...
  getline(m_inMesh, s);
  if (s != "$MeshFormat")
    throw Exception(FATAL, "Unsupported mesh format: " + m_filename);
...
//******************************************************************************
{
  throw Exception(WARNING, "Mesh section '$PhysicalNames -- $EndPhysicalNames'"
                           "not yet implemented");
}
