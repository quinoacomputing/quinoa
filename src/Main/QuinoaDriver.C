...
/*!
  ...
  \author    J. Bakosi
  \date      Mon 29 Jul 2013 09:52:14 PM MDT
...
{
  //  Instantiate geometry object (if any)
  if (control()->get<control::GEOMETRY>() == select::GeometryTypes::ANALYTIC) {
...
//******************************************************************************
{
  ...
  } if (control()->get<control::PHYSICS>() == select::PhysicsTypes::SPINSFLOW) {
