...
/*!
  ...
  \author    J. Bakosi
  \date      Wed 28 Jan 2015 08:44:15 AM MST
...
class UnsMesh {
  ...
  public:
    ...
    const std::vector< std::vector< int > >& lininpoel() const { return m_lininpoel; }
    ...
    const std::vector< std::vector< int > >& triinpoel() const { return m_triinpoel; }
    ...
    const std::vector< std::vector< int > >& tetinpoel() const { return m_tetinpoel; }
