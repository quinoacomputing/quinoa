...
class GeneralizedDirichlet : public Mix<GeneralizedDirichlet> {
  ...
  public:
    ...
    explicit GeneralizedDirichlet(Memory* const memory,
      ...
      m_b(control.get<control::parameter, control::gendirichlet>().b),
      m_S(control.get<control::parameter, control::gendirichlet>().S),
      m_k(control.get<control::parameter, control::gendirichlet>().kappa),
      m_c(control.get<control::parameter, control::gendirichlet>().c) {
